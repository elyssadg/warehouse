            ...
            <div class="card">
                ...
                <div class="pb-4 card-content">
                    <div class="px-4 py-3 recent-message d-flex">
                        ...
                        <div class="name ms-4">
                            <h5 class="mb-1"># {{ $warehouse[0]->warehouse_id }}</h5>
                            <h6 class="mb-1 text-muted">{{ $warehouse[0]->warehouse_city }} {{ $warehouse[0]->warehouse_postalcode }}</h6>
                        </div>
                    </div>
                    <div class="px-4 py-3 recent-message d-flex">
                        <div class="avatar avatar-lg">
                        ...
                        <div class="name ms-4">
                            <h5 class="mb-1"># {{ $warehouse[1]->warehouse_id }}</h5>
                            <h6 class="mb-1 text-muted">{{ $warehouse[1]->warehouse_city }} {{ $warehouse[1]->warehouse_postalcode }}</h6>
                        </div>
                    </div>
                    <div class="px-4 py-3 recent-message d-flex">
                        <div class="avatar avatar-lg">
                        ...
                        <div class="name ms-4">
                            <h5 class="mb-1"># {{ $warehouse[2]->warehouse_id }}</h5>
                            <h6 class="mb-1 text-muted">{{ $warehouse[2]->warehouse_city }} {{ $warehouse[2]->warehouse_postalcode }}</h6>
                        </div>
                    </div>
                    <div class="px-4">
