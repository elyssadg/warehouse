        ...
        <div class="card">
            <div class="card-content">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('product-types.create') }}" class="btn btn-primary icon icon-left"><i
                                ...
                                @foreach ($productTypes as $productType)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('product-types.edit', ['product_type' => $productType->id]) }}"
                                            ...
                                            <form class="deleteForm" data-product-type-id="{{ $productType->id }}"
                                                action="{{ route('product-types.destroy', ['product_type' => $productType->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
