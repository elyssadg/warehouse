...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Retreive Warehouse Item</h4>
        </div>
        <div class="card-content">
            <div class="card-body">
                <form class="form form-horizontal" id="updateForm"
                    action="{{ route('warehouse-item.retreive', ['warehouse_item' => $ids]) }}" method="POST">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 mb-2">
                                {{ $warehouse_item->stock }}
                            </div>

                            <div class="col-md-4">
                                <label for="first-name-horizontal">Retreive value </label>
                            </div>
                            <div class="col-md-8 form-group">
                                <input type="number" id="first-name-horizontal" class="form-control" name="retreive">
                            </div>
                            <x-alert-error />
